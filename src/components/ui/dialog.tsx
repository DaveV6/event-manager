...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn("text-xl leading-none font-bold text-card-foreground pb-2", className)}
      {...props}
    />
  )
}
